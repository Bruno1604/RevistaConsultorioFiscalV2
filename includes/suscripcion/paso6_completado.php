...
<div class="step-pane" id="stepPane6" style="display: none;">
    ...
    <div class="notification-banner alert-warning" style="margin: 0 0 20px; padding: 20px 24px; text-align: left;">
        <strong style="display: block; margin-bottom: 8px; color: var(--navy); font-size: 0.95rem;">
            Podrás solicitar tu factura desde la página principal siguiendo estos pasos:
        </strong>
        <ol style="margin: 0; padding-left: 20px; text-align: left; color: var(--text-md); font-size: 0.92rem; line-height: 1.8;">
